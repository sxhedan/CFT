...
LOCAL	void	unfold_interface_section(POINT*,POINT*,TRI*,TRI*,
	                                 SURFACE*,SURFACE*);
LOCAL   void    propagate_surface_points_1(Front*,Front*);
...
/*
	...
	printf("Entering Hiprop library\n");
        ...
        //propagate_surface_points_1(front,newfront);
...
LOCAL void propagate_surface_points_1(
        Front           *front,
        Front           *newfront)
{
        ...
        start_clock("propagate_surface_points_1");
        ...
        stop_clock("propagate_surface_points_1");
        DEBUG_LEAVE(propagate_surface_points)
}               /*end propagate_surface_points_1*/
