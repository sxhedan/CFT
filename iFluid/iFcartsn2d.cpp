...
void Incompress_Solver_Smooth_2D_Cartesian::surfaceTension_Fedkiw(
	double delta,
	...
	double diffusion[2])
{
    ...
    diffusion[0] += (mu_edge[2]*U1_nb[4]-mu_edge[2]*U1_nb[5]+mu_edge[3]*U1_nb[6]-mu_edge[3]*U1_nb[7])/(top_h[0]*top_h[1]);
    diffusion[1] += (mu_edge[0]*U0_nb[4]-mu_edge[1]*U0_nb[5]+mu_edge[1]*U0_nb[6]-mu_edge[0]*U0_nb[7])/(top_h[0]*top_h[1]);
