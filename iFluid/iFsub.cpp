	...
	IF_PARAMS *iFparams)
{
	...
	movie_option->plot_comp = NO;
	CursorAfterStringOpt(infile,
		"Type y to make movie of component:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_comp = YES;
	movie_option->plot_vel_vector = NO;
	CursorAfterStringOpt(infile,"Type y to make vector velocity field movie:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_vel_vector = YES;
	movie_option->plot_phase_1 = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of phase 1:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_phase_1 = YES;
	movie_option->plot_phase_2 = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of phase 2:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_phase_2 = YES;
	movie_option->plot_dens = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of density:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_dens = YES;
	movie_option->plot_pres_error = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of pressure error:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_pres_error = YES;
	movie_option->plot_divU = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of divergence of velocity:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_divU = YES;
	movie_option->plot_rhot = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of rho_t:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_rhot = YES;
	movie_option->plot_MB_residual = NO;
	CursorAfterStringOpt(infile,"Type y to make movie of mass balance residual:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->plot_MB_residual = YES;
	movie_option->output_connectivity = NO;
	CursorAfterStringOpt(infile,"Type y to output connectivity information:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->output_connectivity = YES;
	movie_option->output_droplet_analysis = NO;
	CursorAfterStringOpt(infile,"Type y to output droplet analysis:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->output_droplet_analysis = YES;
	movie_option->output_tridia = NO;
	CursorAfterStringOpt(infile,"Type y to output triangle diameter information:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->output_tridia = YES;
	movie_option->output_error = NO;
	CursorAfterStringOpt(infile,"Type y to output error with exact solution:");
	fscanf(infile,"%s",string);
	(void) printf("%s\n",string);
	if (string[0] == 'Y' || string[0] == 'y')
	    movie_option->output_error = YES;
	fclose(infile);
